...
const CARD_R5 = [{
        ...
        'text': [
            ...
            '4. Cover your mouth and nose with a cloth mask when you go out. ',
            'NOTE: Children under age 2 and people who have trouble breathing or might not be able to take off their own mask shouldn\'t wear one. Don\'t wear a mask intended for health care workers.'
        ],
...
const CARD_R6 = [{
        ...
        'text': [
            ...
            'COVID-19 can have other symptoms. Contact a medical provider for any severe or concerning symptoms.'
        ]
    },
    {
        "type": "chips",
...
const CARD_R7 = [{
        'type': 'description',
        'text': [
            'Help slow the spread of COVID-19. Take these steps:', '1. Keep a distance of least 6 feet from others.', '2. Avoid crowds or crowded spaces.'
        ],
...
const HEALTH_CONDITION_CARDIO = {
    'event': {
        'languageCode': 'en',
        'name': 'event-health-condition-cardio'
    },
    'type': 'list',
...
const HEALTH_CONDITION_DIABETES = {
    'title': 'Diabetes',
    'event': {
        'name': 'event-health-condition-dm',
        'languageCode': 'en'
    },
    'type': 'list'
};
...
const HEALTH_CONDITION_LUNG = {
    'event': {
        'languageCode': 'en',
        'name': 'event-health-condition-lung'
    },
    'type': 'list',
...
const HEALTH_CONDITION_HEALTHRISK_1 = [{
        ...
        'subtitle': 'Many conditions can cause a person to be immunocompromised, including cancer treatment, smoking, bone marrow or organ transplantation, immune deficiencies, poorly controlled HIV or AIDS, and prolonged use of corticosteroids and other immune weakening medications',
        'event': {
            'languageCode': 'en',
            'name': 'event-health-condition-healtherisk'
        },
        'type': 'list'
    },
    {
...
const HEALTH_CONDITION_NONE = {
    ...
    'event': {
        'languageCode': 'en',
        'name': 'event-health-condition-none'
    },
    'type': 'list'
};
...
const SYMPTOM_MULTI_CHOICE_QUESTION = {
    ...
    shortofbreath: {
        'event': {
            'name': 'event-symptom-shortofbreath',
            'languageCode': 'en'
        },
        'type': 'list',
